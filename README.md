...
Dataset
Field	- Description
Date - Daily record (1 Jan 2024 – 31 Dec 2024)
Route - Six fictional ferry routes
Vessel - Nine vessel names
Month / Month_Name	- For time-based analysis
Season	Peak / Shoulder / Off-Peak - classification
Is_Weekend	- Weekend vs weekday flag
Passenger_Count - Simulated daily passenger count per route

---
Routes Included
Auckland City to Devonport (departs every 30 mins)
Auckland City to Waiheke (departs every 1 hour)
...
Off-Peak: June to August (winter)
---
Skills Demonstrated
